...
/**
 * 支持侧滑删除的RecyclerView
 * Created by fby on 2019/3/4.
 */


class SlideRecyclerView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : RecyclerView(context, attrs, defStyle) {

    private var mVelocityTracker: VelocityTracker? = null   // 速度追踪器
    private val mTouchSlop: Int // 认为是滑动的最小距离（一般由系统提供）
